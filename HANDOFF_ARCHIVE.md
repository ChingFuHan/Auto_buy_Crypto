...
## ARCHIVE APPEND - 2026-05-04 +08:00 - HANDOFF 熱區瘦身 - sha256=c3e1745bf95cf9cca5e65b0fff9256c7bbf8af5efda85e9560a4ad141ab6ff79

### 搬遷摘要
- 任務：將過長的 `HANDOFF.md` 瘦身為熱區版本，並依 `god_rule.md` RULE 01 先將整理前原文完整附加到 `HANDOFF_ARCHIVE.md`。
- 原始 `HANDOFF.md` 行數：822
- 原始 SHA256：`c3e1745bf95cf9cca5e65b0fff9256c7bbf8af5efda85e9560a4ad141ab6ff79`
- 搬遷方式：以下保留整理前 `HANDOFF.md` 完整原文；後續熱區摘要另見新的 `HANDOFF.md`。

### 原文開始：整理前 HANDOFF.md（完整）
